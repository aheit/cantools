...
ACLOCAL = ${SHELL} /home/aheit/ubuntu/cantools-code2/missing aclocal-1.15
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/aheit/ubuntu/cantools-code2/missing autoconf
AUTOHEADER = ${SHELL} /home/aheit/ubuntu/cantools-code2/missing autoheader
AUTOMAKE = ${SHELL} /home/aheit/ubuntu/cantools-code2/missing automake-1.15
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/aheit/ubuntu/cantools-code2/missing makeinfo
MANIFEST_TOOL = :
MATIO_CFLAGS = -I/usr/lib/x86_64-linux-gnu/hdf5/serial/include
MATIO_LIBS = -L/usr/lib/x86_64-linux-gnu/hdf5/serial/lib -lmatio -lhdf5 -lz
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
...
ZLIB_LIBS = -lz
Z_LIB = -lz
abs_builddir = /home/aheit/ubuntu/cantools-code2
abs_srcdir = /home/aheit/ubuntu/cantools-code2
abs_top_builddir = /home/aheit/ubuntu/cantools-code2
abs_top_srcdir = /home/aheit/ubuntu/cantools-code2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/aheit/ubuntu/cantools-code2/install-sh
...
cantomat_CPPFLAGS = -I/usr/lib/x86_64-linux-gnu/hdf5/serial/include \
...
cantomat_LDADD = libcandbc.la libcanasc.la libcanblf.la libcanvsb.la \
	libcanclg.la -L/usr/lib/x86_64-linux-gnu/hdf5/serial/lib -lmatio -lhdf5 -lz -lz $(HDF5_LIB)  \
	-lm
...
mdftomat_CPPFLAGS = -I/usr/lib/x86_64-linux-gnu/hdf5/serial/include \
	   -I$(top_srcdir)/src/libcanmdf

mdftomat_LDADD = libcanmdf.la -L/usr/lib/x86_64-linux-gnu/hdf5/serial/lib -lmatio -lhdf5 -lz -lz $(HDF5_LIB) 
...
matdump_CPPFLAGS = -I/usr/lib/x86_64-linux-gnu/hdf5/serial/include
matdump_LDADD = -L/usr/lib/x86_64-linux-gnu/hdf5/serial/lib -lmatio -lhdf5 -lz -lz $(HDF5_LIB) 
...
libcanmdf_CPPFLAGS = -I/usr/lib/x86_64-linux-gnu/hdf5/serial/include
...
libcanblf_la_LDFLAGS = -no-undefined -version-info 0:19:0
...
libcanmdf_la_CPPFLAGS = -I$(top_builddir)/src/libcanmdf -I/usr/lib/x86_64-linux-gnu/hdf5/serial/include
