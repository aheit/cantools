...
ACLOCAL = ${SHELL} /cygdrive/c/Users/aheit/work/Priv/cantools/GitHub/cantools/missing aclocal-1.15
ALLOCA = 
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /cygdrive/c/Users/aheit/work/Priv/cantools/GitHub/cantools/missing automake-1.15
AWK = gawk
CC = gcc
...
cantomat_LDADD = libcandbc.la libcanasc.la libcanblf.la libcanvsb.la \
	libcanclg.la -lmatio -lz $(HDF5_LIB)  \
	-lm
...
libcandbc_la_LDFLAGS = -no-undefined -version-info 0:23:0
libcanasc_la_CPPFLAGS = -I$(top_builddir)/src/libcanasc \
		      	       -I$(top_srcdir)/src/libcandbc \
		    		   -I$(top_srcdir)/src/cantomat \
                       -I$(top_srcdir)/src/hashtable

libcanasc_la_LDFLAGS = -no-undefined -version-info 0:23:0
...
libcanblf_la_LDFLAGS = -no-undefined -version-info 0:23:0
libcanvsb_la_CPPFLAGS = -I$(top_builddir)/src/libcanvsb \
					   -I$(top_srcdir)/src/libcandbc \
				       -I$(top_srcdir)/src/cantomat \
                       -I$(top_srcdir)/src/hashtable

libcanvsb_la_LDFLAGS = -no-undefined -version-info 0:23:0
libcanclg_la_CPPFLAGS = -I$(top_builddir)/src/libcanclg \
				       -I$(top_srcdir)/src/libcandbc \
	       		       -I$(top_srcdir)/src/cantomat \
                       -I$(top_srcdir)/src/hashtable

libcanclg_la_LDFLAGS = -no-undefined -version-info 0:23:0
libcanmdf_la_CPPFLAGS = -I$(top_builddir)/src/libcanmdf -I//include
libcanmdf_la_LDFLAGS = -no-undefined -version-info 0:23:0
